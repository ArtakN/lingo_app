...
/* In React, useState, as well as any other function starting with ”use”, 
   ...
   while React is rendering. Hooks—functions starting with use—can only 
   be called at the top level of your components or your own Hooks. 
...
/****************************************************************************************
   If we need the old value of state to help to determine the new value of state, 
   we should pass a callback function to the state setter function instead of using 
   state directly. This callback function will receive the old value of state 
   as its parameter, which we wil use to determine our new value of state.
 ***************************************************************************************/
...
function App() {
   ...
   function add() {
      // prevCount (here could be any name) is the old value of the state (count = 0) 
      setCount((prevCount) => {
         return prevCount + 1
      })
...
3. When do we need to pass "Callback function" to the state setter function?
      ...
      here we need 0 to determin 1 --> new state = old state + 1 --> 0 + 1
*/
// =============================================================================
...
function App() {
   ...
   function changeMind() {
      /* here we need the previous value of the state to determine the new value,
         so we will use callback function to return new value of state.
