         ...
         <nav className={`${styles.mobileNav}  ${mobileNav && styles.visable}`}>
            ...
            <ul className={styles.mobileNavList}>
               {!currentUser
                  ...
                  <li onClick={handleMenuItem}><Link to='/login'>Lesson</Link></li>
                  :
                  // If th user is logged in, on Lesson click navigate to Lesson page.
                  <li onClick={handleMenuItem}><Link to='/lesson/parameters'>Lesson</Link></li>
               }
               <li onClick={handleMenuItem}><Link to='/allwords'>All words</Link></li >
               {!!currentUser
                  &&
            ...
            {!currentUser
               ...
               <Link to="/login" className={styles.logInBtn} onClick={handleMenuItem}>Log in</Link>
               :
